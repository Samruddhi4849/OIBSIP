...
This repository contains the tasks completed as part of the **Data Science Internship** at **Oasis Infobyte**.  
Each task focuses on applying data science and machine learning concepts to real-world datasets.
...
The repository is organized into individual task folders.  
Each folder contains:
- Dataset used
- Jupyter Notebook with implementation
- Task-specific README file
...
- Each task folder contains a detailed README explaining the project.
